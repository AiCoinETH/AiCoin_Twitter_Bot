...
TELEGRAM_CHANNEL_ID = os.getenv("TELEGRAM_CHANNEL_ID")  # <-- теперь только это для публикации!

# Диагностика
print("TELEGRAM_BOT_TOKEN_APPROVAL:", TELEGRAM_BOT_TOKEN_APPROVAL[:10] if TELEGRAM_BOT_TOKEN_APPROVAL else None)
